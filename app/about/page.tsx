export default function About() {
  return (
      <div className="space-y-12 text-md md:text-lg text-muted-foreground pb-4 md:pb-8">
          <p>
              Introducing Transformer, the ultimate multimedia conversion powerhouse that empowers you to transform images,
          ...
          <div className="space-y-2">
              ...
              <p>
              Unleash the full potential of your images with our powerful conversion tool. Whether you're looking to resize, crop, rotate, or change formats, we’ve got you covered. Seamlessly switch between JPEG, PNG, and a wide range of formats to effortlessly enhance and perfect your visual content.
              </p>
          </div>
          ...
          <div className="space-y-2">
              ...
              <p>
                  Access Transformer from any device with an internet connection. Whether you're on your computer, tablet,
          ...
          <div className="space-y-2">
              ...
              <p>
              Rest easy knowing that your multimedia files are handled with the highest level of care. We prioritize your privacy and data security, ensuring that your files remain exclusively yours.
              </p>
          </div>
          ...
          <div className="space-y-2">
              <h2 className="text-xl md:text-2xl font-medium text-muted-foreground">
                  🌟 It's Free, It's Powerful, It's Transformer:
              </h2>
              <p>
